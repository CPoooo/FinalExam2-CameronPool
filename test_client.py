...
class TestConeApp(unittest.TestCase):
    def test_add_cone(self):
        ...
        self.assertEqual(r.status_code, 201)  # 201 = cone adding successfully
        data = r.json()
    ...
    def test_update_cone(self):
        ...
        self.assertEqual(r.status_code, 200)  # 200 = successful cone update

    def test_display_all_cones(self):
        r = requests.get("http://localhost:3000/getAllCones")
        self.assertEqual(r.status_code, 200)  # 200 = successful request
